...
namespace HBSIS.MercadoLes.CustoAdicionalBrf.XmlBuilders
{
    ...
    public static class DivergenciaKmOcorrencia
    {
        ...
        public static bool InicioOuFimNoRaio(IEnumerable<Infra.Ocorrencia> ocorrencias)
        {
        ...
        public static bool AvaliarSombraCelularOuCelularDesligado(List<Infra.Ocorrencia> ocorrenciasRota)
        {
